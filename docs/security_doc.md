# Security Document – Codex Heatmap Matrix

## Overview
This document describes the security characteristics of the **Codex Heatmap Matrix** Power BI custom visual. It confirms compliance with Microsoft's security and certification requirements.
...
## 8. Summary
**Codex Heatmap Matrix** is sandbox-compliant, contains no external dependencies, performs no external communication, and adheres to all Microsoft Power BI security requirements.