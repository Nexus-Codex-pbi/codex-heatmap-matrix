# Accessibility Statement – Codex Heatmap Matrix

## Overview
This document outlines the accessibility compliance of the **Codex Heatmap Matrix** Power BI custom visual.
...
## 4. Color Usage
- The visual does not rely solely on colour to convey meaning. The heatmap uses colour saturation and optionally shows numeric values in each cell.
...
## 7. Summary
**Codex Heatmap Matrix** meets Microsoft's accessibility requirements and is designed to be usable by all users, including those relying on assistive technologies.